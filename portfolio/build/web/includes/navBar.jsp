<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-header">
		...
		<span class="icon-bar"></span>
            ...
            <a class="navbar-brand" href="index.jsp">Kate Anderson</a>
	</div>
		...
		<li><a href="./includes/resume.pdf">Resume</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="./HW3/salaryCalculator/web/index.jsp">Salary Calculator</a></li>
                        <li><a href="/familyApp/">Database Application</a></li>
